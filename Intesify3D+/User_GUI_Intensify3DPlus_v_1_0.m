function varargout = User_GUI_Intensify3DPlus_v_1_0(varargin)

% USER_GUI_INTENSIFY3DPLUS_V_1_0 MATLAB code for User_GUI_Intensify3DPlus_v_1_0.fig
%      USER_GUI_INTENSIFY3DPLUS_V_1_0, by itself, creates a new USER_GUI_INTENSIFY3DPLUS_V_1_0 or raises the existing
%      singleton*.
%
%      H = USER_GUI_INTENSIFY3DPLUS_V_1_0 returns the handle to a new USER_GUI_INTENSIFY3DPLUS_V_1_0 or the handle to
%      the existing singleton*.
%
%      USER_GUI_INTENSIFY3DPLUS_V_1_0('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in USER_GUI_INTENSIFY3DPLUS_V_1_0.M with the given input arguments.
%
%      USER_GUI_INTENSIFY3DPLUS_V_1_0('Property','Value',...) creates a new USER_GUI_INTENSIFY3DPLUS_V_1_0 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before User_GUI_Intensify3DPlus_v_1_0_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to User_GUI_Intensify3DPlus_v_1_0_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help User_GUI_Intensify3DPlus_v_1_0

% Last Modified by GUIDE v2.5 22-Oct-2019 10:18:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @User_GUI_Intensify3DPlus_v_1_0_OpeningFcn, ...
                   'gui_OutputFcn',  @User_GUI_Intensify3DPlus_v_1_0_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before User_GUI_Intensify3DPlus_v_1_0 is made visible.
function User_GUI_Intensify3DPlus_v_1_0_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to User_GUI_Intensify3DPlus_v_1_0 (see VARARGIN)

% Choose default command line output for User_GUI_Intensify3DPlus_v_1_0
handles.output = hObject;
addpath(pwd);
% Update handles structure
guidata(hObject, handles);

% UIWAIT makes User_GUI_Intensify3DPlus_v_1_0 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = User_GUI_Intensify3DPlus_v_1_0_OutputFcn(hObject, eventdata, handles) 
...
StringDir = ['1) ',Directories(DirectoryIndex(3)).name]; 
for i = 1:length(DirectoryIndex)-3
StringDir = [StringDir newline num2str(i+1),') ',Directories(DirectoryIndex(i+3)).name];
end
set(handles.text62, 'String', StringDir);
...
ExistingSupportFilesFolder = get(handles.edit22,'String');
...
if mod(MSFS,2)==0; set(handles.edit25,'string',num2str(MSFS+1)); end;
try
    Intensify3D_Plus_V1_0(Folder,Sensitivity,MSFS,MBI,TissueDetection-1,NormType,Threads,ImageToMeasure,FolderToMeasure,handles,UserSelectedThrehold,TissueSmoothing,ExistingSupportFilesFolder,XYNorm-1,AcrossNormType)
catch me
